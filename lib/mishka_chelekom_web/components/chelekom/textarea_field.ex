defmodule MishkaChelekom.TextareaField do
  ...
  defp height_size("extra_small"),
    do: "[&_.textarea-field-wrapper_textarea]:h-10"

  defp height_size("small"),
    do: "[&_.textarea-field-wrapper_textarea]:h-12"

  defp height_size("medium"),
    do: "[&_.textarea-field-wrapper_textarea]:h-11"

  defp height_size("large"),
    do: "[&_.textarea-field-wrapper_textarea]:h-16"

  defp height_size("extra_large"),
    do: "[&_.textarea-field-wrapper_textarea]:h-18"

  defp height_size("auto"),
    do: "[&_.textarea-field-wrapper_textarea]:h-auto"
